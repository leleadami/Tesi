"""
Training script for LSTM Encoder-Decoder model

This script:
1. Loads and preprocesses data (Building 1, Phase 1 for training)
2. Creates LSTM Encoder-Decoder model
3. Trains the model
...
def load_config(config_path: str = '../../configs/encoder_decoder.yaml') -> dict:
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Train LSTM Encoder-Decoder model',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python train_encoder_decoder.py
  python train_encoder_decoder.py --hidden_size 128
  python train_encoder_decoder.py --phase phase_2_online --building_id 1
  python train_encoder_decoder.py --phase phase_2_online --building_id 2 --hidden_size 128 --lr 0.0005
...
Checkpoints saved to: results/checkpoints/{phase}/
    ...
    # Create LSTM Encoder-Decoder model
